...
if (select) {
    ...
    select.value =
        localStorage.getItem("backgroundEffect") || "default";
...
function createDefaultBackground() {
    ...
    container.innerHTML = `
        <div class="background">
            ...
            <img src="/assets/images/bg-logo.png" class="bg-logo logo-1" alt="">

            <img src="/assets/images/bg-logo.png" class="bg-logo logo-2" alt="">

            <img src="/assets/images/bg-logo.png" class="bg-logo logo-3" alt="">

            <img src="/assets/images/bg-logo.png" class="bg-logo logo-4" alt="">

            <img src="/assets/images/bg-logo.png" class="bg-logo logo-5" alt="">

            <img src="/assets/images/bg-logo.png" class="bg-logo logo-6" alt="">
...
function randomBrainrot() {
    ...
    return brainrotImages[
        ...
        Math.floor(
            ...
            Math.random() * brainrotImages.length
